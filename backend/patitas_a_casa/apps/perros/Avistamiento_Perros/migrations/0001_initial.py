    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.CharField(choices=[('M', 'Macho'), ('H', 'Hembra'), ('D', 'Desconocido')], default='D', max_length=30)),
                ('tamaño', models.CharField(choices=[('P', 'Pequeño'), ('M', 'Mediano'), ('G', 'Grande'), ('Gi', 'Gigante')], max_length=10)),
                ...
                ('estado_perro', models.CharField(choices=[('S', 'Saludable'), ('H', 'Herido'), ('D', 'Desnutrido'), ('E', 'Enfermo'), ('Ag', 'Agresivo'), ('As', 'Asustado')], default='S', max_length=10)),
                ...
                ('reportado_por_usuario', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
